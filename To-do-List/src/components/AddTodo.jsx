  ...
  return (
    <div className={`${styles.taskRow} container`}>
      <div className={`${styles.myRow} row`}>
        <div className="col-6">
          <input type="text" placeholder="Enter your Todo" onChange={handleDueTask} value={dueTask}/>
        </div>
        <div className="col-4">
          <input type="date" onChange={handleDueDate} value={dueDate}/>
        </div>
        <div className="col-2">
          <button type="button" value={dueDate} className={`${styles.myBtn} btn btn-success`} onClick={handleAddBtn}>
            Add
          </button>
        </div>
      </div>
